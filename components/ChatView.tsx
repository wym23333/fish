  ...
  return (
    <div className="flex flex-col h-full bg-white relative pt-[44px]">
      ...
      <div className="flex-1 relative overflow-hidden bg-white">
        {/* Aquarium Background - fixed at bottom behind messages */}
        <AnimatePresence>
          {isHungry && (
            <motion.div
              initial={{ opacity: 0 }}
              ...
              className="absolute bottom-0 left-[16px] right-[16px] z-10 pointer-events-none"
              style={{ height: '100px' }}
            >
        ...
        <div className="absolute inset-0 overflow-y-auto px-[16px] pt-[16px] pb-1 no-scrollbar z-20" style={{ paddingBottom: isHungry ? '120px' : '170px', transition: 'padding-bottom 0.4s ease-out' }}>
          <div className="flex flex-col space-y-[16px] relative bg-white">
